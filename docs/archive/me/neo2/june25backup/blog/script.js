...
let footerHTML = "<hr><p>" + blogName + " by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>. Theme by <a href='https://kalechips.net/projects/layouts/'>kalechips</a>.</p>";
...
//==[ 4. INSERTING THEINTO OUR ACTUAL HTML PAGES ]==
